...
const translations: Translations = {
    ...
    updateCoords: { en: "Update Coordinates", es: "Actualizar Coordenadas" },
    googleMapsSearch: { en: "Search on Google Maps", es: "Buscar en Google Maps" },
    userUpdated: { en: "User Updated", es: "Actualizado por Usuario" },
    adminVerification: { en: "Requires Admin Verification", es: "Requiere Verificación de Administrador" },
    save: { en: "Save", es: "Guardar" },
    imageDateTaken: { en: "Image Taken", es: "Imagen Tomada" },
    rainfallHistory: { en: "Rainfall History", es: "Historial de Lluvias" },
    totalRainfall: { en: "Total Rainfall", es: "Precipitación Total" },
    verifiedByBlockchain: { en: "Verified by Blockchain", es: "Verificado por Blockchain" },
    integrityFailure: { en: "Data Tampering Detected!", es: "¡Manipulación de Datos Detectada!" },
